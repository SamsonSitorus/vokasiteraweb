                                        ...
                                        @foreach($kelompok->KelompokMahasiswa as $mhs)
                                            ...
                                            <tr>
                                                    ...
                                                    <form action="{{ $nilai ? route('pembimbing1.NilaiBimbingan.update', $nilai->id) : route('pembimbing1.NilaiBimbingan.store') }}" method="POST">
                                                        ...
                                                        <div class="row">
                                                            @foreach([
                                                                ...
                                                                ['A3', 'Kerjasama dalam tim, sistematik.'],
                                                                ['A4', 'Pemahaman terhadap Materi/Masalah dan Inisiatif dan keaktifan selama pembimbingan.'],
                                                                ['A5', '. Tingkat kelengkapan dan kualitas deliverables.'],
                                                            ] as [$name, $label])
                                                ...
                                                <td class="text-center align-middle">
                                                    ...
                                                    @if($nilai)
                                                        <form action="{{ route('pembimbing1.NilaiBimbingan.destroy', $nilai->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
