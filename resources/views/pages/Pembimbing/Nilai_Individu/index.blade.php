                                    ...
                                    @foreach($kelompoks as $index => $kelompok)
                                        @foreach($kelompok->KelompokMahasiswa as $mhs)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ $nilai ? route('pembimbing1.NilaiIndividu.update', $nilai->id) : route('pembimbing1.NilaiIndividu.store') }}" method="POST">
                                                        @csrf
                                                        @if($nilai)
                                                            @method('PUT')
                                                        @endif
                                                ...
                                                <td class="text-center align-middle">
                                                    ...
                                                    @if($nilai)
                                                        <form action="{{ route('pembimbing1.NilaiIndividu.destroy', $nilai->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
