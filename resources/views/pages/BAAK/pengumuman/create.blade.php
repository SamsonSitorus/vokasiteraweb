...
<section class="section">
    <div class="section-body">
        <form action="{{ route('pengumuman.BAAK.store') }}" method="POST"  enctype="multipart/form-data">
            @csrf
            <div class="card">
                ...
                <div class="card-body">
                         ...
                         <div class="form-group">
                            ...
                            <select name="KPA_id" id="KPA_id" class="select2 form-control" required>
                                ...
                                <option value="{{ $item->id }}"
                                    {{ old('KPA_id') == $item->id ? 'selected' : ''}} > {{ $item->kategori_pa }}</option>
                                    @endforeach
                            </select>
                        </div>
                          {{--  input TA --}}
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="deskripsi" name="deskripsi" class="form-control" rows="10" style="min-height: 200px;" required>{{ old('deskripsi') }}</textarea>
                    </div>
                    {{-- file --}}
                    <div class="form-group">
