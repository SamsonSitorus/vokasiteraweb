            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4>List Nilai Individu Penguji</h4>
                    </div> 
                    <div class="card-body">
                                    ...
                                    @foreach($kelompoks as $index => $kelompok)
                                        @foreach($kelompok->KelompokMahasiswa as $mhs)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ $nilai ? route('penguji1.NilaiIndividu.update', $nilai->id) : route('penguji1.NilaiIndividu.store') }}" method="POST">
                                                        @csrf
                                                        @if($nilai)
                                                            @method('PUT')
                                                        @endif
                                                ...
                                                <td class="text-center align-middle">
                                                    ...
                                                    @if($nilai)
                                                        <form action="{{ route('penguji1.NilaiIndividu.destroy', $nilai->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
