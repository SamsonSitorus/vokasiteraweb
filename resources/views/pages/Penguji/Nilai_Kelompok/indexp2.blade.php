                                ...
                                <tbody>
                                    @foreach($kelompok as $index => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="{{ $nilai ? route('penguji2.NilaiKelompok.update', $nilai->id) : route('penguji2.NilaiKelompok.store') }}">
                                                    @csrf
                                                    @if($nilai)
                                                        @method('PUT')
                                                    @endif
                                           ...
                                           <div class="row" style="width: 100%;">
                                            ...
                                            <td>
                                                ...
                                                @if($nilai)
                                                    <form method="POST" action="{{ route('penguji2.NilaiKelompok.destroy', $nilai->id) }}" class="ml-2" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
