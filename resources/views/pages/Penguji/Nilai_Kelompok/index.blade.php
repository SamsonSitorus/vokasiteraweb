                                ...
                                <tbody>
                                    @foreach($kelompok as $index => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="{{ $nilai ? route('penguji1.NilaiKelompok.update', $nilai->id) : route('penguji1.NilaiKelompok.store') }}">
                                                    @csrf
                                                    @if($nilai)
                                                        @method('PUT')
                                                    @endif
                                            ...
                                            <td>
                                                ...
                                                @if($nilai)
                                                    <form method="POST" action="{{ route('penguji1.NilaiKelompok.destroy', $nilai->id) }}" class="ml-2" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
