...
@section('title', 'Create pembimbing 1')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4>Tambah Pembimbing 1</h4>
                        <a class="btn btn-primary btn-sm" href="{{route('pembimbing.index')}}">Kembali</a>
                    </div>  
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('pembimbing.store')}}" enctype="multipart/form-data">
                            @csrf
