...
@section('title', 'Create pembimbing 2')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4>Tambah Pembimbing 2</h4>
                        <a class="btn btn-primary btn-sm" href="{{route('pembimbing2.index')}}">Kembali</a>
                    </div>  
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('pembimbing2.store')}}" enctype="multipart/form-data">
                            @csrf
                       
                            {{-- Dosen --}}
                        <div class="form-group">
                            <label for="user_id">Pilih Dosen Pembimbing</label>
