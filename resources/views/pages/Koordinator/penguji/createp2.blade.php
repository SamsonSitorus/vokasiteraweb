...
@section('title', 'Create penguji 2')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4>Tambah Penguji 2</h4>
                        <a class="btn btn-primary btn-sm" href="{{route('penguji2.index')}}">Kembali</a>
                    </div>  
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('penguji2.store')}}" enctype="multipart/form-data">
                            @csrf
