            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4>Edit Penguji 2</h4>
                        <a href="{{route('penguji2.index')}}" class="btn btn-primary">Kembali</a>
                    </div>
                    <div class="card-body">

                        <form method="POST" action="{{ route('penguji2.update', Crypt::encrypt($penguji['id'])) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
