                            ...
                            <table class="table table-striped" id="table-2">
                                ...
                                <tbody>
                                     @foreach($pengumuman as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td><a href="{{ route('pengumuman.koordinator.show',$item->id) }}">{{ $item->judul }}</a></td>
                                            ...
                                            <td>
                                            <div class="d-flex">
                                                <a href="{{route('pengumuman.edit', Crypt::encrypt($item->id))}}" class="btn btn-success btn-sm"><i class="nav-icon fas fa-edit"></i> &nbsp; Edit</a>
